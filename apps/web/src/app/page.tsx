...
import { Pill, ArrowRight, Search, BarChart3, Shield, Sparkles } from 'lucide-react'
...
export default function HomePage() {
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-primary/5 via-primary/[0.02] to-background px-4 py-20">
