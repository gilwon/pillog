...
"[project]/apps/web/src/app/api/admin/sync/logs/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const { data: log, error: logError } = await supabase.from('sync_logs').select('*').eq('id', id).single();
        if (logError || !log) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: {
                    code: 'NOT_FOUND',
                    message: '동기화 이력을 찾을 수 없습니다.',
                    status: 404
                }
            }, {
                status: 404
        ...
        let query = supabase.from('sync_log_products').select(`id, sync_log_id, product_id, change_type,
         product:products(id, name, company, report_no)`, {
            count: 'exact'
        }).eq('sync_log_id', id).order('created_at', {
            ascending: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0bcdca3f._.js.map