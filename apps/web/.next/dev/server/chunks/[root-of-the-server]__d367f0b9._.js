...
"[project]/apps/web/src/app/api/admin/sync/logs/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data, count, error } = await supabase.from('sync_logs').select('*', {
            count: 'exact'
        }).order('started_at', {
            ascending: false
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d367f0b9._.js.map