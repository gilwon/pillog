...
"[project]/apps/web/src/app/api/admin/ingredients/[id]/aliases/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, { params }) {
    try {
        ...
        const { data, error } = await supabase.from('ingredient_aliases').select('*').eq('ingredient_id', id).order('alias_name', {
            ascending: true
        });
...
async function POST(request, { params }) {
    try {
        ...
        const { data, error } = await supabase.from('ingredient_aliases').insert({
            ingredient_id: id,
            alias_name,
...
async function DELETE(request, { params }) {
    try {
        ...
        const { error } = await supabase.from('ingredient_aliases').delete().eq('id', aliasId).eq('ingredient_id', id);
        if (error) throw error;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2529d1b8._.js.map