...
async function POST(req) {
    ...
    const orFilter = keywords.map((k)=>`primary_functionality.ilike.%${k}%`).join(',');
    const { data, error } = await supabase.from('products').select('id, name, company, functionality_tags, shape, primary_functionality').or(orFilter);
    if (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: {
                code: 'INTERNAL_ERROR',
    ...
    const withScore = scored.slice(0, 100);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        products: withScore,
        total
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5cc7a644._.js.map