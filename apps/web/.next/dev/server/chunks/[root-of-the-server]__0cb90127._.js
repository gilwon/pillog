...
"[project]/apps/web/src/app/api/admin/products/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(_request, { params }) {
    try {
        ...
        const { data: product, error: fetchError } = await supabase.from('products').select('removed_from_api').eq('id', id).single();
        ...
        if (!product.removed_from_api) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: {
                    code: 'FORBIDDEN',
                    message: 'API 제거된 제품만 영구 삭제할 수 있습니다.',
                    status: 403
                }
            }, {
                status: 403
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0cb90127._.js.map