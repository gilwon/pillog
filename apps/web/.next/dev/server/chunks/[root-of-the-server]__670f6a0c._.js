...
async function GET(request) {
    try {
        ...
        // Fetch products
        const { data: products, error: productsError } = await supabase.from('products').select('id, name, company').in('id', ids);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__670f6a0c._.js.map